      ...
      <section className="relative h-[65vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl">
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}
            ...
            HAIFOS (Hindustani Innovative Forum for Social Impact) is a non-profit organization dedicated to bringing digital equity to rural India.
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            <motion.div {...fadeIn}>
              ...
              <div className="space-y-6 text-text-muted text-sm md:text-base leading-relaxed font-bold">
                ...
                <p>The journey began in <span className="text-primary">Bihar, particularly in the Munger district</span>, where many rural communities still have <span className="text-primary">limited access to digital tools and learning opportunities.</span></p>
